...
- (void)handleTap {
    ...
    // YTM 9.26.2 changed the now-playing hierarchy. The old tweak blindly
    // treated parentViewController.playerViewController as YTPlayerViewController,
    // which caused an unrecognized-selector crash on playerResponse.
